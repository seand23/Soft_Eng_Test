...
class Admin extends User{
    function addProduct($productName, $price, $brandName, $colors, $size) {
        $pdo = get_connection();
    
        //insert product into database
        $query = "INSERT INTO products (productName, price, brandName, colors, size) VALUES (:productName, :price, :brandName, :colors, :size)";
    ...
    function handleProducts($admin) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            if (isset($_POST['addProduct'])) {
                ...
                if ($admin->addProduct($productName, $price, $brandName, $colors, $size)) {
